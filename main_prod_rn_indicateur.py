...
X_data, Y_data= RI.X_data_Y_data_construct(min_num_inst, max_num_inst, 0,"InstanceReseauNeurones/RN_instance_prod__")#en mettant 1 ou 0 cela permet de classé
...
#SM.MLP_LN_regression_FctError_Apprentissag_SaveModel(model, 'adam', 'mean_squared_error', X_train, y_train, 200, 32, 0)#
#print(X_data)
#print(Y_data)
...
#SM.MLP_LN_regression_predire(len(X_test), X_data_test_tensor, y_test, 'SequentialModel_prediction_test.pdf')#

#test sur les instances d'apprentissage
#SM.MLP_LN_regression_predire(len(X_train), X_data_train_tensor, y_train,'SequentialModel_prediction_train.pdf')#
#========================================================
# III.
#========================================================
...
for i in range(1,Nb_epochs+1):
    print("itération : ", i)
    err_test, err_train=AFMP.Cost_value_model_fig_gap_by_epoch(i,in_PR_A_RP0_A_RG_A, in_A_PR_A_N, in_A_moins_A0_A_plus_A0, in_A_plus_A0, in_P_moins_P0_P_plus_P0, in_P_plus_P0, in_K, in_mu, out_Cost_A_P, input0, input1, input2, input3, input4, input5, CMP_list)
...
plt.legend()
plt.savefig('Gap_PROD_prediction_reseauALternativeLearning2_test_data.pdf')
plt.show()