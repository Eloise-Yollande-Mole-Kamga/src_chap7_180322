...
#pour exécuter le fonctionel initiale, aller changer dans le fichier read_instance, la variable N_limite=20 en un N_limite très très grand
...
#    X.append(count_Nb_rechargecount_Nb_recharge[i][0])#
